...
function tablaDatosUsuario() {
  ...
  $("#jsGrid").jsGrid({
    ...
    fields: [
        ...
        { name: "IdPreguntas_Frecuentes", type: "text",validate: "required",css: "hide" },
        { name: "NombrePreguntas_Frecuentes", title: "Nombre", type: "text",validate: "required"},
        { name: "DescripcionPreguntas_Frecuentes", title: "Descripción", type: "text", validate: "required" },
        { name: "Pregunta_Frecuente", title: "Pregunta", type: "text",validate: "required" },
        { name: "RespuestaPreguntas_Frecuentes", title: "Respuesta", type: "text", validate: "required", width: 300 },

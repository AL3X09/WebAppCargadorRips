...
function getAllME() {
    ...
    success: function (response) {
      ...
      $.each(response, function (i, v) {
          ...
          $("#nombreUser").html('<strong>' + v.NombresUsuario + " " + apellido + '</strong>');
        ...
        if ($("#divclaims") != undefined) {
          ...
          $("#divclaims").append('<input type="hidden" name="codigousuario" id="codigousuario" value="' + v.CodPrestadorUsuario + '" />');
        }
...
function tablaDatosUsuario() {
  ...
  $("#jsGrid").jsGrid({
    ...
    fields: [
      ...
      { name: "CodPrestadorUsuario", title: "Código", type: "text", validate: "required", css: "hide"},
      { name: "NombresUsuario", title: "Nombres", type: "text",validate: "required" },
      { name: "ApellidosUsuario", title: "Apellidos", type: "text" },
      { name: "TelefonoUsuario", title: "Telefono", type: "text" },
      { name: "RazonSocialUsuario", title: "Razon social", type: "text", validate: "required"  },

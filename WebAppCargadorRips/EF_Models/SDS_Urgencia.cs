...
public partial class SDS_Urgencia
{

    public long urgencia_id { get; set; }
    ...
    public long destino_salida_id { get; set; }
    ...
    public virtual Destino_Salida Destino_Salida { get; set; }
